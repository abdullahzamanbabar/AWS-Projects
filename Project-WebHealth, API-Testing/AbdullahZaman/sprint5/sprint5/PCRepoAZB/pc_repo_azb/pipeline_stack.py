...
class PipelineStack(core.Stack):
    def __init__(self, scope:core.Construct, id:str, **kwargs):
        ...
        synth = pipelines.CodeBuildStep('synth', input=source,
                commands = [
                "cd AbdullahZaman/sprint5/PCRepoAZB", "pip install -r requirements.txt", "npm install -g aws-cdk", "cdk synth"],
            primary_output_directory="AbdullahZaman/sprint5/PCRepoAZB/cdk.out",
            role=pipeline_role,
        ...
        beta = InfraStage(self, "AbdullahBetaSPRINT5", env={
        'account': '315997497220',
        'region': 'us-east-2'
        })
     
        """
        production = InfraStage(self, "AbdullahProductionSPRINT5", env={
        'account': '315997497220',
        'region': 'us-east-2'
        })
        ...
        unitTest = pipelines.CodeBuildStep(
            ...
            commands=["cd AbdullahZaman/sprint5/PCRepoAZB/","pip install -r requirements.txt", "npm install -g aws-cdk", "pytest unit_tests"],
            role=pipeline_role,
            role_policy_statements=[iam_,sts_]
            )
        ...
        integrationTest = pipelines.CodeBuildStep(
            ...
            commands=["cd AbdullahZaman/sprint5/PCRepoAZB/","pip install -r requirements.txt", "npm install -g aws-cdk", "pytest integration_tests"],
            role=pipeline_role,
            role_policy_statements=[iam_,sts_]
            )
